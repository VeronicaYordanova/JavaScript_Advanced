...
console.log(robotFunc("restock protein 10"));
//console.log(robot("prepare cheverme 1"));
console.log(robotFunc("restock carbohydrate 10"));
//console.log(robot("prepare cheverme 1"));
console.log(robotFunc("restock fat 10"));
//console.log(robot("prepare cheverme 1"));
console.log(robotFunc("restock flavour 10"));
//console.log(robot("prepare cheverme 1"));
console.log(robotFunc("report"));
