...
let Console = require('../_05_C#_Console').Console;
...
describe("class Console static writeLine", function () {
    ...
    it("should return the JSON representation of the object for single parameter", function () {
       let object = { name: 'Pesho', age: 23};
    ...
    it("should throw error if place of placeholders is changed", function () {
        let string = "This {0} should {2} replaced.";
    ...
    it("should throw error if invalid placeholder is given", function () {
        let string = "This {0} should {1} replaced. This one {13} not work.";
        expect(() => Console.writeLine(string, "one", "be")).to.throw(RangeError);
    });
